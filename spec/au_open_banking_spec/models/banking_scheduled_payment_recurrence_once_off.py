...
class BankingScheduledPaymentRecurrenceOnceOff(BaseModel):
    """
    ...
    """ # noqa: E501
    payment_date: StrictStr = Field(description="The scheduled date for the once off payment", alias="paymentDate")
