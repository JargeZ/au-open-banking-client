...
class BankingScheduledPaymentFrom(BaseModel):
    """
    ...
    """ # noqa: E501
    account_id: StrictStr = Field(description="ID of the account that is the source of funds for the payment", alias="accountId")
