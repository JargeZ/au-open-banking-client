...
class BankingTransaction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountId", "transactionId", "isDetailAvailable", "type", "status", "description", "postingDateTime", "valueDateTime", "executionDateTime", "amount", "currency", "reference", "merchantName", "merchantCategoryCode", "billerCode", "billerName", "crn", "apcaNumber"]
