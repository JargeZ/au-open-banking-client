...
class ResponseBankingAccountListV2(BaseModel):
    """
    ResponseBankingAccountListV2
    """ # noqa: E501
    data: ResponseBankingAccountListV2Data
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseBankingAccountListV2Data.from_dict(obj["data"]) if obj.get("data") is not None else None,
