...
class ResponseBankingAccountsBalanceListData(BaseModel):
    """
    ResponseBankingAccountsBalanceListData
    """ # noqa: E501
    balances: List[BankingBalance] = Field(description="The list of balances returned")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "balances": [BankingBalance.from_dict(_item) for _item in obj["balances"]] if obj.get("balances") is not None else None
        })
        return _obj
