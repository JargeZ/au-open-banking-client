...
class ResponseBankingProductByIdV4(BaseModel):
    """
    ResponseBankingProductByIdV4
    """ # noqa: E501
    data: BankingProductDetailV4
    links: Links
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BankingProductDetailV4.from_dict(obj["data"]) if obj.get("data") is not None else None,
