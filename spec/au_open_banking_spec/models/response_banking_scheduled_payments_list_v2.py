...
class ResponseBankingScheduledPaymentsListV2(BaseModel):
    """
    ResponseBankingScheduledPaymentsListV2
    """ # noqa: E501
    data: ResponseBankingScheduledPaymentsListV2Data
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseBankingScheduledPaymentsListV2Data.from_dict(obj["data"]) if obj.get("data") is not None else None,
