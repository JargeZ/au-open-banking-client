...
class BankingInternationalPayeeBankDetailsBankAddress(BaseModel):
    """
    BankingInternationalPayeeBankDetailsBankAddress
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the recipient Bank")
    address: StrictStr = Field(description="Address of the recipient Bank")
