...
class ResponseErrorListV2(BaseModel):
    """
    ResponseErrorListV2
    """ # noqa: E501
    errors: List[ResponseErrorListV2Errors]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [ResponseErrorListV2Errors.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
