...
class ResponseBankingAccountListV2Data(BaseModel):
    """
    ResponseBankingAccountListV2Data
    """ # noqa: E501
    accounts: List[BankingAccountV2] = Field(description="The list of accounts returned. If the filter results in an empty set then this array may have no records")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [BankingAccountV2.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
