...
class BankingScheduledPaymentRecurrenceEventBased(BaseModel):
    """
    ...
    """ # noqa: E501
    description: StrictStr = Field(description="Description of the event and conditions that will result in the payment. Expected to be formatted for display to a customer")
