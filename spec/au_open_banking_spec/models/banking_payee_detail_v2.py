...
class BankingPayeeDetailV2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["payeeId", "nickname", "description", "type", "creationDate", "payeeUType", "biller", "domestic", "digitalWallet", "international"]
