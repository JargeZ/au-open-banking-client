...
class ResponseBankingTransactionList(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseBankingTransactionListData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": LinksPaginated.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "meta": MetaPaginatedTransaction.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
