...
class ResponseBankingAccountByIdV3(BaseModel):
    """
    ResponseBankingAccountByIdV3
    """ # noqa: E501
    data: BankingAccountDetailV3
    links: Links
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BankingAccountDetailV3.from_dict(obj["data"]) if obj.get("data") is not None else None,
