...
class TestBankingAccountDetailV3AllOf(unittest.TestCase):
    """BankingAccountDetailV3AllOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankingAccountDetailV3AllOf:
        """Test BankingAccountDetailV3AllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankingAccountDetailV3AllOf`
        """
        model = BankingAccountDetailV3AllOf()
        if include_optional:
            return BankingAccountDetailV3AllOf(
                bsb = '',
                account_number = '',
                bundle_name = '',
    ...
    def testBankingAccountDetailV3AllOf(self):
        """Test BankingAccountDetailV3AllOf"""
